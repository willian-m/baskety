...
export function GroceryListPage() {
  ...
  const { data: list, isLoading: loadingList } = useGroceryList(
    inventoryId,
    listId,
  );
  const { data: items, isLoading: loadingItems } = useGroceryItems(
    inventoryId,
    listId,
  );
              ...
              {group.map((item, idx) => (
                ...
                >
                  <input
                    ...
                    onChange={() =>
                      handleToggle(item.id, item.status as ItemStatus)
                    }
